...
class AudioDataset(Dataset):
    def __init__(self, manifest, augment=False, snr_db=None, noise_manifest=None):
        ...
        # For SNR runs keep raw audio (noise added per sample).
        # Otherwise precompute log-mels once so epochs don't redo the STFT.
        self.labels = []
        self.audios = []
        self.specs = []
